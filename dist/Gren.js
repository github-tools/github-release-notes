...
var Gren = function () {
    ...
    (0, _createClass3.default)(Gren, [{
                    ...
                    while (1) {
                        switch (_context18.prev = _context18.next) {
                            ...
                            case 8:
                                ...
                                releaseDates = this._sortReleasesByDate(this._transformTagsIntoReleaseObjects(tags));
                                selectedTags = this._getSelectedTags(releaseDates) || (releaseDates.length > 1 ? [releaseDates[0], releaseDates[1]] : releaseDates);
        ...
        key: '_transformTagsIntoReleaseObjects',
        value: function _transformTagsIntoReleaseObjects(tags) {
