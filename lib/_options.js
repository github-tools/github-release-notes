    ...
    changelogOptions: [
        {
            short: '-G',
            name: 'generate',
            description: `${chalk.blue('changelog only')} - Generate the changelog with GithubReleaseNotes rather then using the repo releases`
        },
        {
            short: '-f',
            name: 'changelog-filename',
            valueType: '<filename.md>',
            description: `${chalk.blue('changelog only')} - The name of the changelog file. [CHANGELOG.md]`,
